...
export default function Learn({ articles, site }: LearnProps) {
  ...
  return (
    <Layout
      site={site}
      title="Learn"
      description="Educational guides and informational content"
    >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Explore our in-depth guides, tutorials, and informational articles
          ...
          {articles.length > 0 ? (
            ...
            <div className="text-center py-32 bg-card rounded-3xl border border-dashed border-border">
              <Lightbulb className="mx-auto h-16 w-16 text-muted-foreground/30 mb-6" />
              <p className="text-muted-foreground font-medium text-lg">
                Educational content coming soon. <br />
                Check back for guides and tutorials!
              </p>
            </div>
          )}
        </div>
...
export const getStaticProps: GetStaticProps = async () => {
  const [articles, site] = await Promise.all([
    getArticlesByTypes(["pillar", "lead-gen", "informational"]),
    getSite(),
  ]);
